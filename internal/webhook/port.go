...
type WebhookRepository interface {
	FindByID(ctx context.Context, id kernel.WebhookID) (*WebhookConfig, error)
	...
	Delete(ctx context.Context, id kernel.WebhookID) error
	...
	FindDeliveriesByWebhook(ctx context.Context, webhookID kernel.WebhookID, limit int) ([]*WebhookDelivery, error)
}
