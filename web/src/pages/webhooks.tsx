...
import type {
  WebhookConfig, WebhookDelivery, CreateWebhookRequest, UpdateWebhookRequest,
} from "@/api/types"
...
export default function WebhooksPage() {
  ...
  async function handleUpdate(id: string, req: UpdateWebhookRequest) {
  ...
  async function loadDeliveries(webhookId: string) {
    ...
    const res = await api.webhooks.listDeliveries(webhookId, { limit: 100 })
                  ...
                  <TableCell onClick={(e) => e.stopPropagation()}>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem variant="destructive" onClick={() => setDeleteId(wh.id)}>
...
function WebhookFormDialog({
  ...
  onUpdate: (req: UpdateWebhookRequest) => void
}) {
